...
import { Mail, Phone, Linkedin, Github, Calendar, Award, Code, Cpu, Database, Layers, Terminal, ExternalLink, BookOpen, ChevronDown } from 'lucide-react';
...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'about', 'experience', 'skills', 'education', 'blogs', 'certifications', 'contact'];
  ...
  return (
    <div ref={containerRef} className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-x-hidden">
      ...
      {/* Education Section */}
      <section id="education" className="min-h-screen flex items-center py-20 px-6 bg-slate-900/50">
        <div className="max-w-5xl mx-auto w-full">
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      <section id="blogs" className="min-h-screen flex items-center py-20 px-6">
        <div className="max-w-6xl mx-auto w-full">
          <motion.div
            initial="hidden"
            whileInView="visible"
      ...
      <section id="certifications" className="min-h-screen flex items-center py-20 px-6 bg-slate-900/50">
        <div className="max-w-5xl mx-auto w-full">
          <motion.div
            initial="hidden"
            whileInView="visible"
